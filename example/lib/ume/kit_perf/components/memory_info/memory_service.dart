...
import '../../../core/service/vm_service/service_mixin.dart';
...
class MemoryService with VMServiceWrapper {
  ...
  void getClassDetailInfo(String classId, Function(ClsModel?) completion) async {
    ...
    if (cls.fields != null && cls.fields!.isNotEmpty) {
      ...
      cls.fields?.forEach((fieldRef) {
        Property _property = Property(fieldRef.isConst, fieldRef.isStatic, fieldRef.isFinal,
            fieldRef.declaredType!.name, fieldRef.name);
  ...
  void sort<T>(Comparable<T>? Function(ClassHeapStats d) getField, bool descending,
