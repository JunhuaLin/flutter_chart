...
import 'package:example/ume/core/panel_action_define.dart';
import 'package:example/ume/core/util/constants.dart';
import 'package:example/ume/core/util/store_mixin.dart';
...
class FloatingWidget extends StatefulWidget {
  ...
  final List<({String item1, Widget item2, ToolbarAction item3})>? toolbarActions;
...
class _FloatingWidgetState extends State<FloatingWidget> with StoreMixin {
  ...
  double get toolBarHeight =>
      (widget.toolbarActions != null && widget.toolbarActions!.isNotEmpty) ? _toolBarHeight : 0;
  ...
  void initState() {
    ...
    _dy = _windowSize.height - widget.minimalHeight - _dragBarHeight - toolBarHeight;
    super.initState();
  }
...
class __ToolBarContentState extends State<_ToolBarContent> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Material(
        borderRadius: const BorderRadius.only(topLeft: cornerRadius, topRight: cornerRadius),
        elevation: 20,
        child: Container(
                    ...
                    children: [
                      ...
                      InkWell(
                          ...
                          child: CircleAvatar(
                            radius: 10,
                            backgroundColor:
                                _fullScreen ? const Color(0xffe6c029) : const Color(0xff53c22b),
                          )),
                      Expanded(
